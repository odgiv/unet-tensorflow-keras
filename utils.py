...
class VIS:
    ...
    def add_sample(self, pred, gt):
        ...
        # if type(score_cls) is list and len(score_cls) == 2:
        #     print(type(score_cls))
    ...
    def compute_scores(self, suffix=0):
        ...
        json.dump(self.score_history, open(os.path.join(
            self.path, 'meanIU{}.json'.format(self.suffix)), 'w'), indent=2, sort_keys=True)
