...
with tf.name_scope('cross_entropy'):
    cross_entropy_loss = tf.reduce_mean(ignore_unknown_xentropy(ytrue=label, ypred=pred)) #tf.reduce_mean(tf.nn.sparse_softmax_cross_entropy_with_logits(labels=label, logits=pred))
# define optimizer
